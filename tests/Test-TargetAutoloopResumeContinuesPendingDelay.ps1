...
Assert-True ([string]$command.DispatchEligibleAt -eq $expectedEligibleAtAfterPause) 'resumed delayed queue should preserve the recomputed paused dispatch due timestamp.'
