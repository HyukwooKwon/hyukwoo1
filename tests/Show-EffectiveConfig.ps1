...
$effectiveConfig = [pscustomobject]@{
    ...
    PairTest = [pscustomobject]@{
        ...
        DefaultWatcherMaxForwardCount = [int]$effectivePairTest.DefaultWatcherMaxForwardCount
        DefaultWatcherRunDurationSec = [int]$effectivePairTest.DefaultWatcherRunDurationSec
        DefaultPairMaxRoundtripCount = [int]$effectivePairTest.DefaultPairMaxRoundtripCount
        DefaultPauseAllowed = [bool]$effectivePairTest.DefaultPauseAllowed
