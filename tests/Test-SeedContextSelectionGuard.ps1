...
$tmpRoot = Join-Path $root '_tmp\Test-SeedContextSelectionGuard'
...
Assert-True ([string]$manifest.SeedReviewInputSelection.SelectionMode -eq 'auto-rejected-multiple') 'manifest should record rejected selection mode.'
