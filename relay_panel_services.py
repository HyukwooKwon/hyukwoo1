...
SCRIPT_ARGUMENT_POLICY = {
    ...
    "tests/Publish-TargetAutoloopArtifact.ps1": {"config": True, "run_root": True},
    ...
    "launcher/Get-CodexCliUpdateStatus.ps1": {"config": False},
    "launcher/Restart-BoundVisibleTarget.ps1": {"config": True},
