@{
    ...
    PairTest             = @{
        ...
        HeadlessExec      = @{
            ...
            Arguments                 = @('exec', '--skip-git-repo-check', '--dangerously-bypass-approvals-and-sandbox')
    ...
    Targets              = @(
        @{ Id='target01'; WindowTitle='Relay-Target-01'; Folder='C:\dev\python\hyukwoo\hyukwoo1\inbox\target01'; EnterCount=1; FixedSuffix=$null }
        @{ Id='target02'; WindowTitle='Relay-Target-02'; Folder='C:\dev\python\hyukwoo\hyukwoo1\inbox\target02'; EnterCount=1; FixedSuffix=$null }
        @{ Id='target03'; WindowTitle='Relay-Target-03'; Folder='C:\dev\python\hyukwoo\hyukwoo1\inbox\target03'; EnterCount=1; FixedSuffix=$null }
        @{ Id='target04'; WindowTitle='Relay-Target-04'; Folder='C:\dev\python\hyukwoo\hyukwoo1\inbox\target04'; EnterCount=1; FixedSuffix=$null }
        @{ Id='target05'; WindowTitle='Relay-Target-05'; Folder='C:\dev\python\hyukwoo\hyukwoo1\inbox\target05'; EnterCount=1; FixedSuffix=$null }
        @{ Id='target06'; WindowTitle='Relay-Target-06'; Folder='C:\dev\python\hyukwoo\hyukwoo1\inbox\target06'; EnterCount=1; FixedSuffix=$null }
        @{ Id='target07'; WindowTitle='Relay-Target-07'; Folder='C:\dev\python\hyukwoo\hyukwoo1\inbox\target07'; EnterCount=1; FixedSuffix=$null }
        @{ Id='target08'; WindowTitle='Relay-Target-08'; Folder='C:\dev\python\hyukwoo\hyukwoo1\inbox\target08'; EnterCount=1; FixedSuffix=$null }
    )
}
